        ...
        function singleSelect(){
            ...
            option.forEach((el, index) => {
                ...
                if(el.hasAttribute('selected')){
                    selectTrigger.innerHTML = el.innerHTML +'<img src="/resources/images/svg/angle-down-solid.svg" alt="">';
                };
            });
            ...
            selectTrigger.addEventListener('click', (e) => {
                ...
                li.forEach((el, index) => {
                    el.addEventListener('click', (event) => {
                        ...
                        sibling.querySelector('.directorist-select__dropdown').classList.remove('directorist-select__dropdown-open');
                        item.querySelector('.directorist-select__label').innerHTML = el.querySelector('.directorist-select-dropdown-text').textContent +'<img src="/resources/images/svg/angle-down-solid.svg" alt="">';
                    });
                });
            });
